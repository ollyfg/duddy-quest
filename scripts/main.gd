...
func _play_bar_fight_cinematic(patron: Node) -> void:
	...
	play_cinematic([
		...
		{"type": "spawn_projectile", "from": "NPCs/Patron2", "toward": "NPCs/Patron1"},
		{"type": "wait", "duration": 0.3},
		{"type": "move_npc", "npc": "NPCs/Patron3", "to": rp + Vector2(320.0, 288.0), "speed": 100.0},
		{"type": "spawn_projectile", "from": "NPCs/Patron3", "toward": "NPCs/Patron1"},
		{"type": "wait", "duration": 0.3},
		{"type": "spawn_projectile", "from": "NPCs/Patron1", "toward": "NPCs/Patron3"},
		{"type": "flash", "color": Color(1.0, 0.3, 0.3, 0.6), "duration": 0.2},
		{"type": "move_npc", "npc": "NPCs/Patron1", "to": rp + Vector2(352.0, 352.0), "speed": 140.0},
		{"type": "spawn_projectile", "from": "NPCs/Patron2", "toward": "NPCs/Patron3"},
		{"type": "wait", "duration": 0.3},
		{"type": "move_npc", "npc": "NPCs/Patron2", "to": rp + Vector2(176.0, 304.0), "speed": 130.0},
		{"type": "spawn_projectile", "from": "NPCs/Patron3", "toward": "NPCs/Patron2"},
